<template>
  <slide class="bg-indigo-200 px-8 py-4" prev="/jammmm" next="how-the-jam">
    <div class="text-3xl">
      <h1 class="text-100 mb-10"><span class="font-bold">Why</span> the <span class="bg-yellow-500 px-4">J</span><span class="bg-teal-500 text-teal-900 px-4 font-serif">A</span><span class="bg-orange-600 text-white px-4 font-mono">M</span>?</h1>
      
      <div class="flex mb-10">
        <div class="w-1/2 mr-4">
          <h2 class="text-4xl font-bold mb-2">Better Performance</h2>
        ...
        <div class="w-1/2 ml-4">
          <h2 class="text-4xl font-bold mb-2">Higher Security</h2>
      ...
      <div class="flex">
        <div class="w-1/2 mr-4">
          <h2 class="text-4xl font-bold mb-2">Cheaper, Easier Scaling</h2>
        ...
        <div class="w-1/2 ml-4">
          <h2 class="text-4xl font-bold mb-2">Better DX</h2>
